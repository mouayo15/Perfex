...
<div class="modal fade" id="convert_lead_to_client_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
   <div class="modal-dialog modal-lg" role="document">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
           ...
           <?php echo form_hidden('state','client_state',$lead->state); ?>           
           <?php echo form_hidden('country','country_id',$lead->country); ?>
           <?php echo form_hidden('website','client_website',$lead->email); ?>           
           <?php           
           $not_mergable_customer_fields  = array('userid');
           $not_mergable_contact_fields  = array('id');
   ...
   <div class="client_password_set_wrapper">
      <div class="input-group">
         <input type="hidden" class="form-control password" name="password" autocomplete="off" value="admin">
      </div>
   </div>
