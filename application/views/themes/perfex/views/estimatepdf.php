...
if (!empty($estimate->terms)) {
    ...
    $pdf->SetFont($font_name, '', '8');
    $pdf->Ln(2);
    $pdf->writeHTMLCell('', '', '', '', $estimate->terms.'<div style="margin:0 auto; text-align:center;"><br><br>Société par actions simplifiée - Capital de 23 000,00 € - SIRET : 834 262 438 00056 - SIREN : 834 262 438 <br> RCS : TOULOUSE - APE/NAF : 4322B - Num TVA : FR 19 834 262 438</div>', 0, 1, false, true, 'L', true);
   // $pdf->writeHTMLCell('', '', '', '', $estimate->terms.'<div style="margin:0 auto; text-align:center;"><br><br>Société par actions simplifiée - Capital de 23 000,00 € - SIRET : 834 262 438 00056 - SIREN : 834 262 438 <br> RCS : TOULOUSE - APE/NAF : 4322B - Num TVA : FR 19 834 262 438</div><img src="https://crm.novadia.app/media/public/certificats.png" />', 0, 1, false, true, 'L', true);
}
