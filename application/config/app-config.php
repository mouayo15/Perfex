...
*
*/
define('APP_BASE_URL', 'https://crm.enyaenergie.fr/');
...
*/
define('APP_ENC_KEY', 'd19ce0d181f16e72c39a6f7871fe369f');
 ...
 */
define('APP_DB_USERNAME', 'perfex_enya');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'iJN7jTyupvSWwgv4ThEz');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'perfex_enya');
